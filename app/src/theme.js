...
function paletteForSlot(slot) {
  const sets = [
    ...
    { mode: "light", primary: { main: "#06b6d4" }, secondary: { main: "#22c55e" }, background: { default: "#f0f9ff", paper: "#ffffff" } },
    { mode: "light", primary: { main: "#22c55e" }, secondary: { main: "#0ea5e9" }, background: { default: "#f0f9ff", paper: "#ffffff" } },
    { mode: "dark", primary: { main: "#a78bfa" }, secondary: { main: "#22d3ee" }, background: { default: "#0f172a", paper: "#111827" } },
    { mode: "light", primary: { main: "#0ea5e9" }, secondary: { main: "#f59e0b" }, background: { default: "#f8fafc", paper: "#ffffff" } },
    { mode: "dark", primary: { main: "#22d3ee" }, secondary: { main: "#10b981" }, background: { default: "#0b1222", paper: "#0f172a" } },
    { mode: "light", primary: { main: "#10b981" }, secondary: { main: "#60a5fa" }, background: { default: "#f1f5f9", paper: "#ffffff" } },
  ];
